         ...
         <img src="<c:url value="/resources/images/banner.jpg"/>"/>
            ...
            <div class="container">
               <div class="text-bg">
                  ...
                  <div class="container">
                     <form class="main-form" action="process" method = "get">
                           ...
                           <div class="col-md-9">
                              <div class="row">
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    ...
                                    <input class="form-control" placeholder="America" type="text" name="destination">
                                 </div>
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <label >Ratings</label>
                         
                                    
                                      <input class="form-control" type="number" id="ratings" name="ratings" min="1" max="5">
                                      
                                    
                                 </div>
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <label >Min Price</label>
                                    <input class="form-control" placeholder="00.0" type="number" name="minprice">
                                 </div>
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    ...
                                    <input class="form-control" placeholder="00.0" type="number" name="maxprice">
                                 </div>
                              </div>
                           </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="amazing-box">
                     ...
                     <a href="userSeperateModule">User Module</a><a href="adminModule">Admin Module</a><a href="partnerModule">Partner Module</a>
                  </div>
               </div>
            </div>
         </div>
